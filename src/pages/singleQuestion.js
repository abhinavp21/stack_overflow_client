...
function SingleQuestion() {
  ...
  useEffect(() => {
    ...
    axios({
      method: "GET",
      url: `https://server-stackkkkkk.azurewebsites.net/questions/singleQuestion/${id}`,
      withCredentials: true
    }).then((res) => {
  ...
  function increaseCount() {
    if (loginUser.id !== singleQuestion.user_id)
      axios({
        method: "POST",
        url: `https://server-stackkkkkk.azurewebsites.net/questions/votes-update/${id}`,
        withCredentials: true,
  ...
  function increaseAnswerCount(ansid) {
    if (loginUser.id !== ansid)
      axios({
        url: `https://server-stackkkkkk.azurewebsites.net/questions/answer-votes-update/${id}`,
        method: "POST",
        withCredentials: true,
  ...
  function handleSubmit(e) {
    ...
    axios({
      method: "POST",
      url: `https://server-stackkkkkk.azurewebsites.net/questions/add-answer/${id}`,
      withCredentials: true,
      data: newAnswerObj
    }).then(res => {
      console.log(res.data);
